...
CNN_ONLY_MODEL_PATH = "model_cnn_only.pth"
...
def train_cnn_only():
    ...
    for epoch in range(cfg.EPOCHS):
        ...
        print(
            f"[CNN-ONLY] Epoch {epoch+1}/{cfg.EPOCHS} | "
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), CNN_ONLY_MODEL_PATH)

    print(f"[CNN-ONLY] Best model saved to {CNN_ONLY_MODEL_PATH} | Best Val Acc: {best_val_acc*100:.2f}%")
